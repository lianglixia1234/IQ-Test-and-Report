...
ASSESSMENT_NOTICE = """
瑞文标准渐进矩阵测试主要测量流体智力（如逻辑推理、抽象思维、图形分析能力），并不涵盖语言表达、记忆力、情绪管理、实践能力、创造力等多种认知与人格维度。因此，请勿仅依据本测试结果对个体整体智力水平或未来发展潜力作出单一判断。

测试结果可能受到测试环境、身体状态、情绪状况、专注程度及答题态度等因素影响，单次测评结果仅供参考。

未成年受测者的认知能力仍处于持续发展阶段，通过科学训练、良好教育环境及持续学习，相关能力可获得进一步提升。

• 所有评估结果均应结合成长经历、教育背景及现实表现进行综合理解。

• 认知能力具有可发展性，可通过科学训练持续提升。

• 每个人都拥有独特的能力结构与优势领域。
"""

DISCLAIMER = """
本测评工具仅作为认知能力辅助筛查与教育参考之用，不构成医学诊断、升学依据或人才选拔标准。测试结果仅供参考，使用者应结合实际情况审慎理解和应用相关结论。
"""
